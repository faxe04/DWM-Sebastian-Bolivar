    ...
    <body>
        ...
        <div class="container py-4">
            ...
            <div class="d-flex align-items-center gap-3 mb-4">
                <img src="img/profile.jpg" class="rounded-circle" style="width:100px; height:100px; object-fit:cover;" alt="Foto canal">
                <div>
                    <h2 class="mb-1">Nombre canal</h2>
                    <p class="text-muted mb-2">@nombrecanal</p>
